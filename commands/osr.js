...
module.exports = {
	name: 'osr',
    description: 'This command shows the most recent pass (in the past 24 hours) about a specific osu! player.\n If you are not registered, you will need to specify a user.',
    cooldown: 10,
	...
	async execute(msg, args, cl, Register) {
        ...
        const query = 'https://osu.ppy.sh/api/get_user_recent?u=' + searchuser + '&k=' + osuapikey + '&limit=50';
        ...
        if(body.length > 0) {
            ...
            if(foundpass) {
                ...
                const resultEmbed = new Discord.RichEmbed()
                    ...
                    .setDescription('This User didn\'t pass any map recently on osu!standard mode.')
                    .setTimestamp()
                    .setFooter(msg.author.tag);
                    msg.channel.send(resultEmbed);
            }
